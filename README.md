...
```
 - Добавлено автоматическое обновление БД с интервалом в 1 час с помощью API Центробанка используя JAXB -библиотеку.
 - Добавлено поле "буквенный код iso".
 - Добавлен новый метод в контроллер для вывода всех валют
 - Стиль кода соответствует Google Java Style
